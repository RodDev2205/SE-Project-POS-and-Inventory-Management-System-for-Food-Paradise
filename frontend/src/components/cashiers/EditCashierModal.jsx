        ...
        <div className="fixed inset-0 flex justify-center items-center z-50 bg-opacity-30 backdrop-blur-sm">
            <div className="bg-white backdrop-blur-md border border-white/20 p-6 rounded-xl shadow-lg w-96">
                ...
                <form className="space-y-3" onSubmit={handleSubmit}>
                    <input type="text" name="name" value={formData.name} onChange={handleChange} className="w-full p-3 border rounded-lg bg-white/40 backdrop-blur-sm" required />
                    ...
                    <select name="role" value={formData.role} onChange={handleChange} className="w-full p-3 border rounded-lg bg-white/40 backdrop-blur-sm">
                        <option value="Trainee Cashier">Trainee Cashier</option>
                        <option value="Senior Cashier">Senior Cashier</option>
                        <option value="Shift Supervisor">Shift Supervisor</option>
                    </select>
                    <select name="status" value={formData.status} onChange={handleChange} className="w-full p-3 border rounded-lg bg-white/40 backdrop-blur-sm">
