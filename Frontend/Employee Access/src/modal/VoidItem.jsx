...
export default function VoidItem({ itemName, onProceed, onCancel }) {
    return (
        <div className="fixed inset-0 bg-opacity-40 backdrop-brightness-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-8 w-96 shadow-xl">
                <h2 className="text-xl font-bold text-center mb-4">Void Item?</h2>

                <p className="text-center text-base mb-8">
                    Are you sure you want to void item <span className="font-semibold">{itemName}</span>?
                </p>
